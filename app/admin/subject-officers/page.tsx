...
import "../../../i18n";
import { UserPlus, X, ToggleLeft, ToggleRight, Check, ShieldAlert } from "lucide-react";
    ...
    return (
      <div style={{ padding: "40px 24px", maxWidth: "600px", margin: "60px auto", textAlign: "center", backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #fee2e2", boxShadow: "0 10px 25px rgba(0,0,0,0.05)" }}>
        ...
        <p style={{ color: "#64748b", fontSize: "0.95rem", lineHeight: 1.6, marginBottom: "24px" }}>
          {lang === "si"
            ? "ශාඛා ප්‍රධානී (Chief Clerk) පරිපාලකයෙකු නොවන බැවින්, විෂයභාර නිලධාරීන් ලියාපදිංචි කිරීම හෝ කළමනාකරණය කිරීමේ අවසර නොමැත."
            : "Chief Clerk accounts do not have administrator privileges to manage or register subject officers."}
        </p>
        <button
          type="button"
