...
const formatFutureAction = (key: string | null | undefined, t: any) => {
  ...
  const map: Record<string, string> = {
    ...
    statusInstitutionalPreliminary: t("statusInstitutionalPreliminary", "Institutional Preliminary Investigation"),
    statusProvincialPreliminary: t("statusProvincialPreliminary", "Delegation of authority to conduct a provincial preliminary investigation"),
    institutionalBasicInvestigation: t("institutionalBasicInvestigation", "Institutional Basic Investigation"),
    provincialBasicInvestigation: t("provincialBasicInvestigation", "Provincial Basic Investigation"),
    "Institutional Basic Investigation": t("institutionalBasicInvestigation", "Institutional Basic Investigation"),
    "Provincial Basic Investigation": t("provincialBasicInvestigation", "Provincial Basic Investigation"),
  ...
  useEffect(() => {
    const verifyAndFetch = async () => {
      ...
      try {
        ...
        const allowedRoles = ["admin", "assistant_secretary_discipline", "senior_assistant_secretary", "additional_secretary", "chief_clerk", "chief_clerk_discipline", "chief_clerk_investigation", "assistant_secretary_investigation", "system_admin"];
