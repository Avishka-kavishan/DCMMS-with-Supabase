  ...
  useEffect(() => {
    const verifyAndFetch = async () => {
      ...
      try {
        ...
        const allowedRoles = ["admin", "assistant_secretary_discipline", "senior_assistant_secretary", "additional_secretary", "chief_clerk", "assistant_secretary_investigation", "system_admin"];
