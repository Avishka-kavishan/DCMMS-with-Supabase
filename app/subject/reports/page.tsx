    ...
    try {
      ...
      if (fetchedCases.length === 0) {
        fetchedCases = [
          {
            id: "sample-1",
            caseNo: "DMMS/2026/001",
            assignedDate: "2026-08-01",
            receivedDate: "2026-08-01",
            letterDate: "2026-07-28",
            subject: "Preliminary Investigation regarding disciplinary inquiry",
            priority: "high",
            status: "In Progress",
          ...
          {
            id: "sample-3",
            caseNo: "DMMS/2026/003",
            assignedDate: "2026-07-15",
            receivedDate: "2026-07-15",
            letterDate: "2026-07-10",
            subject: "Final report submission for completed preliminary case",
            priority: "low",
            status: "Closed",
            officerName: activeOfficerName,
            extensionStatus: "None"
      ...
      <header className="top-header">
        <div className="top-header-left">
          ...
          <div className="header-title-container">
            <h1 className="header-title">DCMMS</h1>
            <span className="header-subtitle">Subject Officer Workspace</span>
          </div>
        </div>

        <div className="top-header-right">
          <div className="accessibility-controls" aria-label="Font scale options">
            <button
        ...
        <div className="reports-container">
          ...
          <div className="reports-header-card">
            <div className="reports-header-title-area">
              <h1>{t("subjectOfficerReportsTitle", "Subject Officer Reports & Analytics")}</h1>
              <p>
                {t(
                  "subjectOfficerReportsSubtitle",
          ...
          <div className="reports-filter-panel">
            <div className="reports-filter-header">
              <h3>
                ...
                <span>{t("reportFilters", "Report Filters & Search")}</span>
              </h3>
            ...
            <div className="reports-filter-grid">
              <div className="filter-group">
                <label>{t("search", "Search Case / Subject")}</label>
              ...
              <div className="filter-group">
                <label>{t("caseStatus", "Status")}</label>
                <select
              ...
              <div className="filter-group">
                <label>{t("timeExtension", "Time Extensions")}</label>
                <select
                  className="filter-control"
                      ...
                      <tr key={item.id}>
                        ...
                        <td>
                          {item.extensionStatus && item.extensionStatus !== "None" ? (
                            <span className="text-xs bg-purple-50 text-purple-700 border border-purple-200 px-2 py-1 rounded font-medium">
                        ...
                        <td>
                          ...
                          >
                            ...
                            {item.status === "Closed" && <CheckCircle className="w-3 h-3" />}
